 ...
 *
 * FileName: FightServer.h
 * 
 * Purpose:  Define FightServer
 *
 * Author:   Jhon Frank(xaquariuscore@163.com)
 * 
 * Modify:   2017/2/22 16:21
===================================================================+*/
#ifndef _FIGHTSERVER_H_
#define _FIGHTSERVER_H_
...
class CFightServer : public CAquariusServer, public ISingleton<CFightServer>
{
public:
    // Constructor
    CFightServer();
    ...
    // Destructor
    virtual ~CFightServer() override final;
